...
void exportChemicalProps(py::module& m)
{
    py::class_<ChemicalProps>(m, "ChemicalProps")
        ...
        .def("speciesCorrectiveMolarVolume", &ChemicalProps::speciesCorrectiveMolarVolume, "Return he derivatives of the corrective molar volume of each phase in the system with respect to species mole fractions at constant temperature and pressure (in m³/mol).")
